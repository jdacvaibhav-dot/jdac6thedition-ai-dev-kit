...
This project is also a Declarative Automation Bundle (DAB), generated using the
`default-python` template.

* `src/`: Python source code for this project.
  * `src/jdac6thedition_ai_dev_kit/`: Shared Python code that can be used by jobs and pipelines.
