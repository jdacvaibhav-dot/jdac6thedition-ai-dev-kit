...
that solves the following, and use your writing-plans skill to write a plan for it before touching any code:
...
3. Granting read access on the new schema to a group called
...
6. All resources should be fully self-contained in the bundle. DO NOT use the python
   SDK or CLI for creating/editing resources.
```
